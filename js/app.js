(() => {
    ...
    function moveMouse(e) {
        if (e.clientX < 25 || e.clientY < 25 || e.clientY > window.innerHeight - 25 || e.clientX > window.innerWidth - 25) mouse.style.opacity = 0; else {
    ...
    gsap.from(".hero__name", 1, {
        delay: 1.5,
        opacity: 0,
        x: -20,
        ease: Expo.easeInOut
    });
    gsap.from(".hero__job", 1, {
        delay: 2,
        opacity: 0,
        x: -20,
        ease: Expo.easeInOut
    });
    gsap.from(".slider-hero__body", 1, {
        delay: 3.3,
        opacity: 0,
        scale: 1.5,
        ease: Expo.easeInOut
    });
    gsap.from(".slider-hero__portfolio", 1, {
        delay: 2.8,
        opacity: 0,
        y: 30,
        ease: Expo.easeInOut
    });
    gsap.from(".hero__contact *", 1.2, {
        delay: 3.6,
        opacity: 0,
        y: 20,
        stagger: .1,
